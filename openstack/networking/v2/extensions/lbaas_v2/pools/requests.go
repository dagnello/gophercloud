...
func CreateAssociateMember(c *gophercloud.ServiceClient, poolID string, opts CreateMemberOpts) AssociateResult {
	type member struct {
		Name         string `json:"name,omitempty"`
		TenantID     string `json:"tenant_id,omitempty"`
...
func UpdateAssociateMember(c *gophercloud.ServiceClient, poolID string, memberID string, opts UpdateMemberOpts) UpdateResult {
	type member struct {
		Name         string `json:"name,omitempty"`
		Weight       int    `json:"weight,omitempty"`
		AdminStateUp *bool  `json:"admin_state_up,omitempty"`
