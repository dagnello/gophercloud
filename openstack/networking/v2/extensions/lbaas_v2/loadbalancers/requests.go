...
import (
	...
	//"github.com/rackspace/gophercloud/openstack/networking/v2/extensions/lbaas/listeners"
)
...
// associated with another loadbalancer. If the pool is already used by another
// loadbalancer, then the operation will fail with a 409 Conflict error will be
// returned.
//
